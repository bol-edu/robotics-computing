...
int64 EstimateMotion::RNG_uniform(int64 a, int64 b)
{
    return a == b ? a : (int64)(RNG_next() % (b - a) + a);
}

unsigned EstimateMotion::RNG_next()
{
    RNG_state = (uint64)(unsigned)RNG_state * RNG_COEF + (unsigned)(RNG_state >> 32);
