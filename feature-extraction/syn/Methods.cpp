		  ...
		  /*  FilterEngine__proceed(this_,
		    ...
		    for (;; dstF += dststep * i, dy += i)
		    {
		        ...
		        for (; dcount-- > 0; srcF += srcstep)
		        {
		            ...
		            uchar* brow = (uchar*)(ptr) + 12 + bi * this_.bufStep;
		            //brow[1] = 0;
		            uchar* row = isSep ? &this_.srcRow[0] : brow;
				...
				brows0 = (uchar*)(ptr)+12 + bi_[0] * this_.bufStep;

				brows1 = (uchar*)(ptr)+12 + bi_[1] * this_.bufStep;

				brows2 = (uchar*)(ptr)+12 + bi_[2] * this_.bufStep;

				brows3 = (uchar*)(ptr)+12 + bi_[3] * this_.bufStep;

				brows4 = (uchar*)(ptr)+12 + bi_[4] * this_.bufStep;

				brows5 = (uchar*)(ptr)+12 + bi_[5] * this_.bufStep;

				brows6 = (uchar*)(ptr)+12 + bi_[6] * this_.bufStep;

				brows7 = (uchar*)(ptr)+12 + bi_[7] * this_.bufStep;

				brows8 = (uchar*)(ptr)+12 + bi_[8] * this_.bufStep;

				brows9 = (uchar*)(ptr)+12 + bi_[9] * this_.bufStep;
