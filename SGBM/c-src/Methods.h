...
public:
	...
	cv::Mat calc_depth_map_1(cv::Mat disp_left, cv::Mat k_left, cv::Mat t_left, cv::Mat t_right, bool rectified);
	cv::Mat stereo_2_depth(cv::Mat img_left, cv::Mat img_right, cv::Mat P0, cv::Mat P1, bool matcher, bool rgb, bool rectified);
	cv::Mat stereo_2_depth_1(cv::Mat img_left, cv::Mat img_right, cv::Mat P0, cv::Mat P1, bool matcher, bool rgb, bool rectified);
